...
#page = "https://www.linkedin.com/in/efarra/recent-activity/shares/"
...
driver.get(page+"login?fromSignIn=true&trk=guest_homepage-basic_nav-header-signin")
...
driver.get(post_url)
#texttest=BSoup.findAll("div",{"class":"occludable-update ember-view"})
#print(texttest)
